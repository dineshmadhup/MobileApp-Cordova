...
function btn_checkout_handler() {
    ...
    if (contactPhone == "")
    {
        document.getElementById('error_phone').innerHTML = 'Telephone numbe must filled';
        document.getElementById('phone').focus();
    }
    else if (!contactPhone.match(phoneValid)) {
        document.getElementById('error_phone').innerHTML = 'Require valid Telephone number';
        document.getElementById('phone').focus();
    }
    else
...
function valid_month() {
    ...
    if (month == '') {
        ...
        document.getElementById('cred_exp_month').innerHTML = 'Enter valid 2 digit month';
...
function valid_year() {
    ...
    if (year == '') {
        ...
        document.getElementById('cred_exp_year').innerHTML = 'Enter valid 2 digit year';
        document.getElementById('year').focus();
    }
...
function valid_credit_card_number() {
    ...
    if (num == '') {
        ...
        document.getElementById('valid_cred_card_num').innerHTML = 'Card number must be filled';
