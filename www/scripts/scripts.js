...
function btn_checkout_handler() {
    ...
    if (contactPhone == "")
    {
        document.getElementById('error_phone').innerHTML = 'Telephone number is required';
...
function valid_credit_card_number() {
    ...
    if (num == '') {
        ...
        document.getElementById('valid_cred_card_num').innerHTML = 'Credit card number is required';
...
function store() {
    ...
    {
        alert("Already in cart and added again");
